...
public final class BarUtils {
    ...
    public static int getActionBarHeight() {
        ...
        if (BaseApplication.sContext.getTheme().resolveAttribute(android.R.attr.actionBarSize, tv, true)) {
            return TypedValue.complexToDimensionPixelSize(
                    tv.data, BaseApplication.sContext.getResources().getDisplayMetrics()
            );
        }
        return 0;
    }
    ...
    private static void invokePanels(final String methodName) {
        try {
            ...
            Object service = BaseApplication.sContext.getSystemService("statusbar");
    ...
    public static int getNavBarHeight() {
        Resources res = BaseApplication.sContext.getResources();
    ...
    private static String getResNameById(int id) {
        try {
            return BaseApplication.sContext.getResources().getResourceEntryName(id);
    ...
    public static boolean isSupportNavBar() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN_MR1) {
            WindowManager wm = (WindowManager) BaseApplication.sContext.getSystemService(Context.WINDOW_SERVICE);
        ...
        boolean menu = ViewConfiguration.get(BaseApplication.sContext).hasPermanentMenuKey();
